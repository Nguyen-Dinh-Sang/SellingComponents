...
namespace WindowsForms.DataAccess.Context
{
    public partial class SellingComponentsDBContext : DbContext
    {
        private static SellingComponentsDBContext instance;
        private SellingComponentsDBContext()
        {
        }
        public static SellingComponentsDBContext getInstance()
        {
            if (instance == null)
            {
                instance = new SellingComponentsDBContext();
            }
